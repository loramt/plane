...
class MicrosoftOAuthProvider(OauthAdapter):
    ...
    def __init__(self, request, code=None, state=None, callback=None):
        ...
        if not (MICROSOFT_CLIENT_ID and MICROSOFT_CLIENT_SECRET):
            raise AuthenticationException(
                error_code=AUTHENTICATION_ERROR_CODES.get(
                    ...
                    AUTHENTICATION_ERROR_CODES.get("OAUTH_NOT_CONFIGURED", "OAUTH_NOT_CONFIGURED")
                ),
        ...
        auth_url = f"https://login.microsoftonline.com/common/oauth2/v2.0/authorize?{urlencode(url_params)}"
    ...
    def set_token_data(self):
        ...
        # Microsoft returns expires_in as seconds from now
        ...
        super().set_token_data(
            {
                ...
                "refresh_token_expired_at": None,  # Microsoft doesn't provide this directly
    ...
    def set_user_data(self):
        ...
        user_data = {
            "email": email,
            "user": {
                "avatar": "",  # Microsoft Graph requires separate call for photo
