...
class WorkspaceViewViewSet(BaseViewSet):
    ...
    @iam_permission(action="view:read")
    ...
    @iam_permission(action="view:update")
    ...
    @iam_permission(action="view:delete")
