...
class IssueAttachmentEndpoint(BaseAPIView):
    ...
    @iam_permission(action="attachment:create")
    ...
    @iam_permission(action="attachment:delete")
    ...
    @iam_permission(action="attachment:read")
...
class IssueAttachmentV2Endpoint(BaseAPIView):
    ...
    @iam_permission(action="attachment:update")
