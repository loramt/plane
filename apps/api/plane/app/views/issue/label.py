...
from plane.app.permissions import ProjectBasePermission, ROLE, iam_permission
...
class LabelViewSet(BaseViewSet):
    ...
    @iam_permission(action="label:create")
    ...
    @iam_permission(action="label:update")
    ...
    @invalidate_cache(path="/api/workspaces/:slug/labels/", url_params=True, user=False)
    @iam_permission(action="label:delete")
